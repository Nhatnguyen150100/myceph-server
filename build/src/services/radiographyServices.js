...
var radiographyServices = {
  getRadiography: function getRadiography(idPatient) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return db.Radiography.findOne({
                where: {
                  idRadiography: idPatient
                }
              });
            case 3:
              radiography = _context.sent;
              if (radiography) {
                resolve({
                  status: 200,
  ...
  updateRadiography: function updateRadiography(idPatient, data) {
    return new Promise( /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(resolve, reject) {
        var dataUpdate, radiographyUpdate, newRadiography;
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return db.Radiography.update(dataUpdate, {
                where: {
                  idRadiography: idPatient
                }
              });
            case 4:
              radiographyUpdate = _context2.sent;
...
var _default = radiographyServices;
