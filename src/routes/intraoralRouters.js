...
router.put('/updateIntraoral/:id', middlewareController.verifyToken, patientMiddleware.checkPatientExists, doctorMiddleware.checkDoctorExistsByIdFromBody ,intraoralControllers.updateIntraoral);
