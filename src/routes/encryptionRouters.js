...
router.post('/encryptionForDoctor/:id', middlewareController.verifyToken, doctorMiddleware.checkDoctorExistsById, encryptionControllers.setEncryptionForDoctor);
router.delete('/encryptionForDoctor/:id', middlewareController.verifyToken, doctorMiddleware.checkDoctorExistsById, encryptionControllers.deleteEncryptionForDoctor);
